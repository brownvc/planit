...
from data import House, DatasetToJSON, ObjectCategories
...
if __name__ == '__main__':
    ...
    if args.task == 'arrange':
        ...
        for (i, n) in enumerate(placeables):
            ...
            ignore_cats = ags.category_map.all_arch_categories()
            ags.sample_placement(node=n, n_samples=args.num_samples_per_object, houses_log=houses_log,
                                 ignore_categories=ignore_cats if args.ignore_doors_windows else [])
